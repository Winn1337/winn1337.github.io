export const projects = [
    {
        ...
        year: 2025,
        summary: "Rage inducing physics platformer.",
        fullDescription: `
        <h3>Introduction</h3>
        <p>
    ...
    },
    {
        ...
        year: 2025,
        summary: "Story-based action-horror first person shooter.",
        fullDescription: `
        <h3>Introduction</h3>
        <p>
        ...
        <h3>Result</h3>
        <p>
        Will add more details about the result.
        </p>
    ...
    },
    {
        title: "WFC RTS",
        year: "2024",
        summary: "Wave Function Collapse RTS level generator.",
        fullDescription: `
        <h3>Introduction</h3>
        <p>
        Will add an introduction when I have the time.
